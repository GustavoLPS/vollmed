...
class MedicoControllerTest {
    ...
    @Autowired
    private JacksonTester<MedicoRecord> dadosCadastroMedicoJson;

    @Autowired
    private JacksonTester<MedicoUpdateReturnRecord> dadosDetalhamentoMedicoJson;
    ...
    void cadastrar_cenario2() throws Exception {
        var dadosCadastro = new MedicoRecord(
                "Medico",
                "medico@voll.med",
                "61999999999",
                "123456",
        ...
        var dadosDetalhamento = new MedicoUpdateReturnRecord(
                null,
                dadosCadastro.nome(),
                dadosCadastro.email(),
                dadosCadastro.crm(),
        ...
        when(medicoService.save(any())).thenReturn(dadosDetalhamento);
